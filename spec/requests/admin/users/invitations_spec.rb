...
RSpec.describe "/admin/users/invitations", type: :request do
  ...
  describe "GET /admin/invitations" do
    it "renders to appropriate page" do
      ...
      get admin_users_invitations_path
  ...
  describe "GET /admin/invitations/new" do
    it "renders to appropriate page" do
      get new_admin_users_invitation_path
  ...
  describe "POST /admin/invitations" do
    it "creates new invitation" do
      post admin_users_invitations_path,
  ...
  describe "POST /admin/invitations/:id/resend" do
    ...
    it "enqueues an invitation email to be resent" do
      assert_enqueued_with(job: Devise.mailer.delivery_job) do
        post resend_admin_users_invitation_path(invitation.id)
      end
  ...
  describe "DELETE /admin/invitations" do
    ...
    it "deletes the invitation" do
      expect do
        delete admin_users_invitation_path(invitation.id)
      end.to change { User.all.count }.by(-1)
      expect(response.body).to redirect_to admin_users_invitations_path
    end
  end
end
